...
public class TLDChecker {
	private static final String			REGEX_SLD_INVALID_CHAR	= "[\\^\\$\\*\\+\\\\/_\\|\\?\"&%#':;=~`!@\\(\\)\\[\\]\\{\\}\\<\\>\\s]";
	...
	public static String cleanDomainName(String domainName) {
		String dom = "";
		String s = domainName.toLowerCase();
		s = s.replaceAll( REGEX_SLD_INVALID_CHAR, "" );
